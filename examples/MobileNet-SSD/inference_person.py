...
caffe_model='deploy/MobileNetSSD_deploy_2035_person.caffemodel'  #Required: where is your deploy caffemodel is located
test_dir = "/home/tolotra/MyDataset/tutorial_person/Images" #Required: your image testing directory
vid_dir = "/home/tolotra/MyDataset/tutorial_person/Videos/myvid.mp4" #Optional or required if you chose video. 

CLASSES = ('background',
           'person')  #Required: your labels in order according to your labelmap.prototxt
