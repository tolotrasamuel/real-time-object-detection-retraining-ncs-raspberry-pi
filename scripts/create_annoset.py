...
if __name__ == "__main__":
  ...
  if not os.path.exists(root_dir):
    print("root directory: {} does not exist1".format(root_dir))
    sys.exit()
  ...
  if not os.path.exists(list_file):
    print("list file: {} does not exist2".format(list_file))
    sys.exit()
  ...
  with open(list_file, "r") as lf:
    for line in lf.readlines():
      ...
      if not os.path.exists(root_dir + img_file):
        print("image file: {} does not exist3".format(root_dir + img_file))
      if anno_type == "classification":
        ...
        if not os.path.exists(root_dir + anno):
          print(root_dir)
          print("annofation file: {} does not exist4".format(root_dir + anno))
          sys.exit()
      break
  # check if label map file exist
  if anno_type == "detection":
    if not os.path.exists(label_map_file):
      print("label map file: {} does not exist5".format(label_map_file))
      sys.exit()
